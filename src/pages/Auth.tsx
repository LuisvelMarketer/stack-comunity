...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-gradient-to-br from-background via-card to-muted">
      ...
      <Card className="w-full max-w-md shadow-[0_8px_32px_0_rgba(0,0,0,0.12)] backdrop-blur-sm bg-card/95 border-border/50 relative z-10">
