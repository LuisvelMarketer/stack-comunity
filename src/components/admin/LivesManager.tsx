...
export function LivesManager() {
  ...
  const updateMutation = useMutation({
    ...
    onError: (error) => {
      toast.error("Error al actualizar sesión: " + error.message);
    },
  });
  ...
  const handleEdit = (live: LiveSession) => {
    ...
    setFormData({
      ...
      community_id: live.community_id,
    });
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (!formData.title.trim() || !formData.scheduled_at || !formData.stream_url.trim() || !formData.community_id) {
      ...
      <CardHeader className="flex flex-row items-center justify-between">
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent className="max-w-lg">
            <DialogHeader>
              <DialogTitle>
                {editingLive ? "Editar Sesión en Vivo" : "Crear Nueva Sesión en Vivo"}
              </DialogTitle>
            </DialogHeader>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder="https://youtube.com/watch?v=... o enlace de Zoom"
                />
              </div>
              <div>
              ...
              <TableBody>
                {lives?.map((live) => (
                  <TableRow key={live.id}>
                    ...
                    <TableCell>{live.communities?.name}</TableCell>
                    <TableCell>
